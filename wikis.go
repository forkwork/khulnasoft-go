...
type (
	...
	//
	// KhulnaSoft API docs:
	// https://docs.khulnasoft.com/api/wikis/
	WikisService struct {
		client *Client
	}
)
...
// Wiki represents a KhulnaSoft wiki.
//
// KhulnaSoft API docs:
// https://docs.khulnasoft.com/api/wikis/
type Wiki struct {
...
// WikiAttachment represents a KhulnaSoft wiki attachment.
//
// KhulnaSoft API docs:
// https://docs.khulnasoft.com/api/wikis/
...
// WikiAttachmentLink represents a KhulnaSoft wiki attachment link.
//
// KhulnaSoft API docs:
// https://docs.khulnasoft.com/api/wikis/
...
//
// KhulnaSoft API docs:
// https://docs.khulnasoft.com/api/wikis/#list-wiki-pages
...
//
// KhulnaSoft API docs:
// https://docs.khulnasoft.com/api/wikis/#get-a-wiki-page
...
//
// KhulnaSoft API docs:
// https://docs.khulnasoft.com/api/wikis/#create-a-new-wiki-page
...
//
// KhulnaSoft API docs:
// https://docs.khulnasoft.com/api/wikis/#edit-an-existing-wiki-page
...
//
// KhulnaSoft API docs:
// https://docs.khulnasoft.com/api/wikis/#delete-a-wiki-page
...
//
// KhulnaSoft API docs:
// https://docs.khulnasoft.com/api/wikis/#upload-an-attachment-to-the-wiki-repository
